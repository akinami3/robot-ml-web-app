 ...
 * - Zustandストア: 他のページでもロボットデータを使うため
 ...
 *
 * 【コンポーネントを分離する理由】
 * ダッシュボードにはサマリーカードが複数あり、全て同じ構造です。
 * コンポーネントとして分離すると:
 ...
 * Bot, Activity など、アイコンコンポーネントを受け取るための型です。
 *
 * 【カード内のレイアウト】
 * ┌──────────────────────┐
 * │  [アイコン]  42        │
